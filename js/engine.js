...
var Engine = (function(global) {
    ...
    function startScreen() {
        ...
        ctx.fillStyle = "#000";
        ctx.fillText("CLASSIC ARCADE GAME", 90, 90);


        ctx.font = "normal 18pt Comic Sans MS";
        ...
        ctx.font = "normal 18pt Comic Sans MS";
        ctx.fillText("Press key to select your player", 100, 420);
    ...
    function GameOver() {
        ...
        ctx.font = "bold 20pt Comic Sans MS";
        ctx.fillStyle = "#000";
        ctx.fillText("CLASSIC ARCADE GAME", 70, 80);

        ctx.font = "bold 50pt Comic Sans MS";
        ctx.fillStyle = "red";
        ctx.fillText("GAME OVER", 50, 250);
        ctx.font = "bold 22pt Comic Sans MS";
        ctx.fillStyle = "#000";
        ctx.fillText("YOUR SCORE: " + score, 130, 320);
        ctx.font = "normal 18pt Comic Sans MS";
        ctx.fillText("Please, press F5 to play the game again", 30, 420);
    ...
    function GameWin() {
        ...
        ctx.rect(0, 0, canvas.width, canvas.height);
        ctx.fill();
        ctx.font = "bold 35pt Comic Sans MS";
        ctx.fillStyle = "red";
        ctx.fillText("*WELL DONE*", 100, 210);
        ctx.font = "normal 18pt Comic Sans MS";
        ctx.fillStyle = "#000";
        ctx.fillText("YOU WON THE GAME", 125, 300);
        ctx.fillText("YOUR SCORE: " + score, 150, 380);
        ctx.font = "normal 18pt Comic Sans MS";
        ctx.fillText("Press F5 to play the game again.", 87, 450);
