...
//  rendering the score on the canvas
Player.prototype.renderScoreBoard = function() {
    // Display Score Board with score, level, lives 
    ctx.fillStyle = '#fff';
    ctx.fillRect(0, 0, 505, 50);

    ctx.fillStyle = '#000';

    ctx.font = "normal 16pt Comic Sans MS";
    ctx.fillText("SCORE: ", 20, 30);
    ctx.fillText("LEVEL: ", 150, 30);
    ctx.fillText("LIVE: ", 270, 30);
